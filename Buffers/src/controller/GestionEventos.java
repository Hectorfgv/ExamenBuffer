...
public class GestionEventos {
	...
	private int call_buscarPalabra() {
		...
		try {
			...
			view.getTextArea().setText("Esta linea es "+valor+" de longitud");
		} catch (FileNotFoundException e) {
			
			view.showError("Se ha producido un error de file not found");
		}
		catch (IOException e) {
	...
	*/
	...
	private int call_buscarPalabra() {
		...
		// TODO: Gestionar excepciones
		try {
			int valor = model.longitudPalabra(view.getFichero1().getText(),view.getPalabra().getText(),view.getPrimera().isSelected());
			view.getTextArea().setText("Esta linea tiene "+valor+" de longitud");
		} catch (FileNotFoundException e) {
